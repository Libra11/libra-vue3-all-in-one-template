<!--
 * @Author: Libra
 * @Date: 2023-04-14 10:40:17
 * @LastEditTime: 2023-04-17 09:35:54
 * @LastEditors: Libra
 * @Description: 
-->
<template>
	<transition name="pop">
		<div
			...
			class="transition-width fixed overflow-hidden rounded-sm bg-color"
		...
		>
			<header class="header flex cursor-move items-center justify-between p-4" @mousedown="handleMouseDown" @mouseup="handleMouseUp">
				...
				<div class="close-btn h-7 w-7 transition-colors hover:text-primary" @click="handleClose" />
			</header>
